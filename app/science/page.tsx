...
import { getScience } from "../lib/content";
...
export default async function Science() {
  ...
  return <PageShell>
    ...
    <section className="moa-home section-pad"><div className="section-heading"><p className="eyebrow light">{c.moaEyebrow}</p><h2>{c.moaHeading}</h2><p>{c.moaDescription}</p></div><MoaExplorer compact variant="hypotheses" /></section>
